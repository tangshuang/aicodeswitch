...
export function ClaudeCodeIcon({ size = 16, x, y, style, className, title }: AgentIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
...
export function CodexIcon({ size = 16, x, y, style, className, title }: AgentIconProps) {
  const raw = useId();
  const fillId = `codex-grad-${raw.replace(/[:]/g, '')}`;
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
    ...
    >
      ...
      />
      <defs>
        <linearGradient id={fillId} gradientUnits="userSpaceOnUse" x1="12" x2="12" y1="3" y2="21">
